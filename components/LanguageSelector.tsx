      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full max-w-7xl animate-in fade-in duration-700">
        {LANGUAGES.map((lang, idx) => {
          ...
          return (
            <button
              key={lang.id}
              onClick={() => onSelect(lang, lang.interpreters[0])}
              className="group relative flex flex-col p-5 rounded-2xl bg-[#121214] border border-white/5 hover:border-white/10 hover:bg-[#18181b] transition-all duration-300 text-left overflow-hidden"
            ...
            >
              ...
              <div className="mt-auto flex gap-2">
                <span className="text-[10px] font-medium px-2 py-1 rounded bg-black/40 text-slate-400 border border-white/5">
